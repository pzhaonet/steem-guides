...
![](images/08_steemworld_03.png)


**General Data：通用数据**
查看账户创建日期，上次点赞日期等

![](images/08_steemworld_04.png)


**Account Details: 账户详情**
查看账户简介，剩余宽带等。

![](images/08_steemworld_05.png)


**Delegations(In): 代理给你**
查看谁代理SP给你

![](images/08_steemworld_06.png)


**Delegations(Out): 代理委派**
查看你把SP代理给谁

![](images/08_steemworld_07.png)


**Followers: 粉丝**
查看粉丝

![](images/08_steemworld_08.png)


**Mentions: 提到你**
查看谁在文章/回复里提到你

![](images/08_steemworld_09.png)
